...
<body>
    <header class="header">
        <div class="header__inner">
            ...
            <form action="{{route('login')}}" class="login-form" method="get">
    ...
    <main>
        <div class="content">
            ...
            <div class="form-area">
                ...
                <input type="password" name="password" id="password-input" placeholder="例:coachtech1106">                <button type="submit" class="register-form__button">登録</button>
                </form>
            </div>
        </div>
    </main>
